...
const RelianceEducationNetwork = () => {
  ...
  const schoolData = [
    {
      ...
      location: "Bhaktapur, Kavre (Dhulikhel)",
      established: "2010",
      students: "800+",
    },
    {
      id: 2,
      title: "Reliance Secondary School",
      image:
  ...
  const collegeData = [
    {
      ...
      location: "Mibachowk, Kavre, Kathmandu",
      programs: "BBA, BCA, BSc.IT",
      students: "1200+",
    },
    {
      id: 2,
      title: "Reliance Technical College",
      image:
        "https://images.unsplash.com/photo-1571019613454-1cb2f99b2d8b?w=300&h=200&fit=crop",
      location: "New Baneshwor, Kathmandu",
      programs: "Engineering, IT",
      students: "800+",
    },
    {
      id: 3,
      title: "Reliance Management College",
      image:
  ...
  const stats = [
    ...
    { number: "100%", label: "Excellence", icon: "⭐" },
  ];

  const socialLinks = [
    {
      name: "website",
      url: "https://www.relianceeducation.edu.np",
      icon: (
    ...
    {
      name: "facebook",
      url: "https://www.facebook.com/relianceeducationnetwork",
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "instagram",
      url: "https://www.instagram.com/relianceeducationnetwork",
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "linkedin",
      url: "https://www.linkedin.com/company/reliance-education-network",
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "youtube",
      url: "https://www.youtube.com/@relianceeducationnetwork",
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
    ...
    {
      name: "tiktok",
      url: "https://www.tiktok.com/@relianceeducationnetwork",
      icon: (
        <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24">
  ...
  const SchoolCard = ({ data, index }) => (
    ...
    >
      ...
      <div className="p-6 relative">
        ...
        {/* Social links - Fixed to show all 6 icons in proper grid layout */}
        <div className="grid grid-cols-3 gap-4 max-w-[120px] mx-auto">
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 py-12 relative z-10">
        ...
        >
          <h1 className="text-6xl font-black text-transparent bg-clip-text bg-gradient-to-r from-white via-blue-200 to-purple-200 mb-6 tracking-tight">
          ...
          <div className="flex items-center justify-center mb-6">
            ...
            <span className="text-white/80 mx-6 text-lg font-light tracking-wider">
              For Your Right Move
            </span>
            <div className="h-px bg-gradient-to-r from-transparent via-white/50 to-transparent w-32"></div>
          </div>
